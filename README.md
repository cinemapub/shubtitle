...
Version : v0.0.1 (2023-11-28 10:17)
Purpose : replace subtitles on video
Usage   : shubtitle [-h] [-q] [-v] [-f] [-l <log_dir>] [-t <tmp_dir>] [-W <width>] [-H <height>] [-Y <vertical>] [-F <font>] [-S <start>] [-E <end>] [-T <title>] [-P <points>] <action> <input?> <output?>
Flags, options and parameters:
    ...
    <action>         : [choice] action to perform  [options: subtitle,action2,check,env,update]
